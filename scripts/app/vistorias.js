...
var page = {
	...
	vistorias: new model.VistoriaCollection(),
	collectionView: null,
	vistoria: null,
	modelView: null,
	isInitialized: false,
	...
	init: function() {
		...
		$('#vistoriaDetailDialog').on('show',function() {
			page.dialogIsOpen = true;
		});

		// when the model dialog is closed, let page know and reset the model view
		$('#vistoriaDetailDialog').on('hidden',function() {
			$('#modelAlert').html('');
			page.dialogIsOpen = false;
		});

		// save the model when the save button is clicked
		$("#saveVistoriaButton").click(function(e) {
			e.preventDefault();
			page.updateModel();
		});
		...
		this.collectionView = new view.CollectionView({
			el: $("#vistoriaCollectionContainer"),
			templateEl: $("#vistoriaCollectionTemplate"),
			collection: page.vistorias
		});
			...
			success: function(c){
				...
				c.forEach(function(item,index) {
					dd.append(app.getOptionHtml(
						...
						page.vistoria.get('engenheiroid') == item.get('id')
					));
				});
