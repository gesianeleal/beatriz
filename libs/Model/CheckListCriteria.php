...
require_once("DAO/CheckListCriteriaDAO.php");

/**
 * The CheckListCriteria class extends CheckListDAOCriteria and is used
 ...
 * @version 1.0
 */
class CheckListCriteria extends CheckListCriteriaDAO
{
