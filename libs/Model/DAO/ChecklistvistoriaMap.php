...
/**
 * ChecklistvistoriaMap is a static class with functions used to get FieldMap and KeyMap information that
 * is used by Phreeze to map the ChecklistvistoriaDAO to the checklistvistoria datastore.
 *
 ...
 * @version 1.0
 */
class ChecklistvistoriaMap implements IDaoMap, IDaoMap2
{
