...
require_once("DAO/VistoriaCriteriaDAO.php");

/**
 * The VistoriaCriteria class extends VistoriaDAOCriteria and is used
 ...
 * @version 1.0
 */
class VistoriaCriteria extends VistoriaCriteriaDAO
{
