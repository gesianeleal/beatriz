...
require_once("DAO/QuestaoCriteriaDAO.php");

/**
 * The QuestaoCriteria class extends QuestaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class QuestaoCriteria extends QuestaoCriteriaDAO
{
