...
require_once("DAO/EngenheiroCriteriaDAO.php");

/**
 * The EngenheiroCriteria class extends EngenheiroDAOCriteria and is used
 ...
 * @version 1.0
 */
class EngenheiroCriteria extends EngenheiroCriteriaDAO
{
