...
<h1>
	...
	<script type="text/template" id="obraCollectionTemplate">
		...
		<thead>
			<tr>
				...
				<th id="header_Municipio">Municipio<% if (page.orderBy == 'Municipio') { %> <i class='icon-arrow-<%= page.orderDesc ? 'up' : 'down' %>' /><% } %></th>
			</tr>
		</thead>
		<tbody>
		...
		<form id="deleteObraButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<button id="deleteObraButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete Obra</button>
						<span id="confirmDeleteObraContainer" class="hide">
							<button id="cancelDeleteObraButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeleteObraButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<div class="modal hide fade" id="obraDetailDialog">
		...
		<div class="modal-footer">
			...
			<button id="saveObraButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>
	...
	<p id="newButtonContainer" class="buttonContainer">
		<button id="newObraButton" class="btn btn-primary">Add Obra</button>
	</p>
