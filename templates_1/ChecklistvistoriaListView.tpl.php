...
<h1>
		...
		<form class="form-horizontal" onsubmit="return false;">
			<fieldset>
				...
				<div id="vistoriaidInputContainer" class="control-group">
					<label class="control-label" for="vistoriaid">Vistoriaid</label>
					<div class="controls inline-inputs">
				...
				<div id="questaoidInputContainer" class="control-group">
					<label class="control-label" for="questaoid">Questaoid</label>
					<div class="controls inline-inputs">
				...
				<div id="tipoavaliacaoInputContainer" class="control-group">
					<label class="control-label" for="tipoavaliacao">Tipoavaliacao</label>
					<div class="controls inline-inputs">
		...
		<form id="deleteChecklistvistoriaButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<button id="deleteChecklistvistoriaButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete Checklistvistoria</button>
						<span id="confirmDeleteChecklistvistoriaContainer" class="hide">
							<button id="cancelDeleteChecklistvistoriaButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeleteChecklistvistoriaButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<div class="modal hide fade" id="checklistvistoriaDetailDialog">
		<div class="modal-header">
			...
			<h3>
				<i class="icon-edit"></i> Edit Checklistvistoria
		...
		<div class="modal-footer">
			...
			<button id="saveChecklistvistoriaButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>
	...
	<p id="newButtonContainer" class="buttonContainer">
		<button id="newChecklistvistoriaButton" class="btn btn-primary">Add Checklistvistoria</button>
	</p>
