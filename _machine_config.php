...
GlobalConfig::$CONNECTION_SETTING->ConnectionString = "mysql942.umbler.com";
GlobalConfig::$CONNECTION_SETTING->DBName = "beatriz";
GlobalConfig::$CONNECTION_SETTING->Username = "gesianeleal";
GlobalConfig::$CONNECTION_SETTING->Password = "junior1703";
...
/** the root url of the application with trailing slash, for example http://localhost/beatriz/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'beatriz/';
